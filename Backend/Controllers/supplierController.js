...
router.get("/admin/readOne/:supplierId", authenticateadmin, async (req, res) => {
    if (!req.params.supplierId) {
        return res.status(400).send({
            err: "Supplier id should be provided!",
        });
...
router.post("/create", authenticateadmin, async (req, res) => {
    ...
    if (!req.body.adresses) {
        return res.status(400).send({
            err: "adresses feild is required !",
        });
    }
...
router.patch("/admin/update/:supplierId", authenticateadmin, async (req, res) => {
    if (!req.params.supplierId) {
        return res.status(400).send({
