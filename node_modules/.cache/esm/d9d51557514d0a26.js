let Router,authenticatesupplier,Product;_514‍.x([["productController",()=>productController]]);_514‍.w("express",[["Router",["Router"],function(v){Router=v}]]);_514‍.w("../MiddleWare",[["authenticatesupplier",["authenticatesupplier"],function(v){authenticatesupplier=v}]]);_514‍.w("../Models/Product",[["Product",["Product"],function(v){Product=v}]]);
...
router.get("/viewmyproducts", authenticatesupplier, (req, res) => {
    _514‍.g.console.log(req.supplier._id)
...
router.patch("/decreaseproductsquantity", authenticatesupplier, (req, res) => {
    ...
    const promise = new Promise((resolve, reject) => {
        _514‍.g.console.log(req.body.products)
