let response,Router,authenticateadmin,authenticateuser,User;_f0f‍.x([["userController",()=>userController]]);_f0f‍.w("express",[["response",["response"],function(v){response=v}],["Router",["Router"],function(v){Router=v}]]);_f0f‍.w("../MiddleWare",[["authenticateadmin",["authenticateadmin"],function(v){authenticateadmin=v}],["authenticateuser",["authenticateuser"],function(v){authenticateuser=v}]]);_f0f‍.w("../Models/User",[["User",["User"],function(v){User=v}]]);
...
router.post("/registerUser", (req, res) => {
  ...
  newuser
    ...
    .catch((err) => {
      _f0f‍.g.console.log(err.message ? err.message : err);
      res.status(400).send({
        err: err.message ? err.message : err,
      });
    });
...
router.patch("/addtocart", authenticateuser, (req, res) => {
  ...
  _f0f‍.g.console.log(req.user.cart);
});
